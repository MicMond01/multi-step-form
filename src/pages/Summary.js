...
const Summary = () => {
  ...
  return (
    <div>
      {" "}
      {Object.keys(planValue).length > 0 ? (
        <div className="flex sm:bg-transparent absolute left-[7.5%] top-[15%] sm:left-0 sm:top-0 sm:relative bg-White justify-center w-[85%] h-[550px] sm:h-[100%] sm:w-[130%] rounded-xl  p-4  pt-10 sm:pr-0  ">
          <form>
            <div>
              <h3 className=" text-Marine font-bold t text-[25px] ">
                Finishing up
              </h3>
            ...
            >
                ...
                <div className="mt-3">
                  {check.map((item) => (
                    <div className="flex justify-between" key={item.id}>
                      ...
                      <h4 className="font-semibold text-Marine">
                        {item?.price}
                      </h4>
                    </div>
                  ))}
              ...
              <div className="flex justify-between mt-6">
                ...
                <h4 className="b font-bold text-Purplish">
                  ${totalPrice()}/yr
                </h4>
              </div>
            </div>
